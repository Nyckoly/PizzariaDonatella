$('section#domingo-perfeito').waypoint(function(direcao){
        ...
        if(direcao == "down"){
            $('div.folha1').removeClass('animate__animated animate__fadeOutLeft');
            $('div.folha3').removeClass('animate__animated animate__fadeOutRight');
            $('div.camarao').removeClass('animate__animated animate__fadeOutLeft animate__slow');
            $('div.tomate').removeClass('animate__animated animate__fadeOutRight animate__slow');
            $('div.folha2').removeClass('animate__animated animate__fadeOutLeft animate__slower');
            $('div.queijo').removeClass('animate__animated animate__fadeOutRight animate__slower');
            ...
            $('div.folha1').addClass('animate__animated animate__fadeOutLeft');
            $('div.folha3').addClass('animate__animated animate__fadeOutRight');
            $('div.camarao').addClass('animate__animated animate__fadeOutLeft animate__slow');
            $('div.tomate').addClass('animate__animated animate__fadeOutRight animate__slow');
            $('div.folha2').addClass('animate__animated animate__fadeOutLeft animate__slower');
            $('div.queijo').addClass('animate__animated animate__fadeOutRight animate__slower');
        }
        else{}
